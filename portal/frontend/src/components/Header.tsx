      ...
      <div className="flex items-center gap-3">
        <div className="relative">
          ...
          <input
            ...
            className="h-9 w-72 rounded-lg border border-[var(--card-border)] bg-[var(--background)] pl-9 pr-4 text-sm text-[var(--text-primary)] placeholder-[var(--text-muted)] outline-none transition-colors focus:border-[var(--kpi-accent)] focus:ring-1 focus:ring-[var(--kpi-accent)]"
          />
        </div>
      </div>
