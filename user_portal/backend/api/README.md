...
- **FMCG data stays in PostgreSQL**: The SQL Agent executes generated queries against PostgreSQL. Chat history and session data go to MongoDB. Clean separation.
